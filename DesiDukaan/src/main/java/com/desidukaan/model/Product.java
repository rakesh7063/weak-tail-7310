...
public class Product {
	...
	public Product(
			@Size(min = 5, max = 30, message = "Product name should have atleast 5 character") String productName,
			@Min(value = 1, message = "Please provide a valid price") double price, String color, String dimension,
			String specification, String manufacturer,
			@Min(value = 1, message = "Please provide a valid quantity") Integer quantity, Category category) {
		super();
